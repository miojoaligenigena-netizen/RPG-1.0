#notas: fazer sistema de up de status(não se esquecer da vida max), loja, npcs/dialogos
...
def player_info(nome, hp, magia, forca, classe, level, pxp):  # Informações sobre o player
    print('==================================================================')
    print(f'            Status: Magia {magia}, Força {forca}, Vida {hp}')
    print(f'            Nome: {nome}     |     Classe: {classe2}')
    print(f'            Level: {level}   |     Xp: {pxp}')
    print('==================================================================')

def painel(nome, hp, mhp, pxp, magia, forca, classe, level): 
    ...
    if painel == 'help':
        ...
        player_info(nome, hp, magia, forca, classe, level, pxp)
    elif painel == 'hunter':
...
def combate(hp, mhp, dano, classe, nome, pxp, level):  # Função de combate
...
# --------------------------------------------------------------------- Primeiro combate -----------------------------------------------------------------------------
hp, mhp, pxp, xp, level = combate(hp, mhp, dano, classe, nome, pxp, level)
      
hp, mhp, pxp = painel(nome, hp, mhp, pxp, magia, forca, classe, level)
